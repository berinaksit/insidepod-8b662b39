...
export function HomeView({ currentTab, onTabChange }: HomeViewProps) {
  ...
  const connectedSources = [
    { name: 'Salesforce_CRM Data', icon: '☁️', color: 'text-blue-400' },
    { name: 'Drive_User Interviews', icon: '📁', color: 'text-yellow-400' },
    { name: 'Meeting transcript_Sales 2025', icon: '📄', color: 'text-blue-300' },
  ];

  const activeAgents = [
    { name: 'Risk Scanner', icon: Scan },
    { name: 'Weekly Review', icon: Calendar },
    { name: 'Adoption Tracker', icon: Activity },
    { name: 'Insights Synthesis', icon: MessageSquare },
    { name: 'Retention Monitor', icon: MonitorCheck },
    { name: 'Trend Summarizer', icon: TrendingUp },
  ];
            ...
            >
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="insight-card">
                  ...
                  <div className="flex items-center gap-2 mt-auto pt-16 text-muted-foreground">
                ...
                <div className="insight-card">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-muted/50 border border-border/50 rounded-lg px-4 py-2 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring"
                    />
                  </div>
                </div>
                ...
                <div className="insight-card">
                  ...
                  <h3 className="text-xl font-medium text-foreground leading-relaxed mb-auto">
                    Which emerging patterns matter for our next release?
                  </h3>
                  <div className="flex items-center gap-2 mt-16 text-muted-foreground">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {activeAgents.map((agent) => {
                      ...
                      return (
                        <button
                          key={agent.name}
                          className="flex items-center gap-2 px-3 py-2.5 bg-muted/50 hover:bg-muted rounded-xl text-sm text-foreground transition-colors"
                        >
