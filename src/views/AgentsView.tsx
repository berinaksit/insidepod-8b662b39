  ...
  return (
    <div className="min-h-full px-6 py-8">
      ...
      >
        <div className="insight-card">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-3xl font-semibold text-foreground leading-none">{mockAgents.length}</p>
        ...
        <div className="insight-card">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-[hsl(145,60%,92%)] flex items-center justify-center flex-shrink-0">
      ...
      <motion.div
        ...
        className="insight-card !p-0 overflow-hidden"
      >
