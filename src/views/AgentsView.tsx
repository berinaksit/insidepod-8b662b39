...
export function AgentsView() {
  return (
    <div className="min-h-full px-6 py-8">
      ...
      >
        <div>
          <h1 className="font-display text-2xl text-foreground mb-1">Agents</h1>
      ...
      >
        ...
        <div className="insight-card">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-xl bg-tertiary-surface flex items-center justify-center">
              <Bot className="w-5 h-5 text-tertiary-surface-foreground" />
            </div>
            <div>
              <p className="text-2xl font-medium text-foreground">
