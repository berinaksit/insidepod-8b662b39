      ...
      <DialogContent className="sm:max-w-2xl bg-card border-0 rounded-3xl shadow-2xl p-0 overflow-hidden">
        ...
        <div className="analysis-panel analysis-panel-primary p-6 pb-8">
          <div className="flex items-start justify-between mb-4">
            ...
            >
              <X className="w-5 h-5 text-primary-surface-foreground" strokeWidth={1.8} />
            </button>
          </div>
              ...
              {suggestedActions.map((action, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <ArrowRight className="w-4 h-4 text-muted-foreground group-hover:text-foreground transition-colors" strokeWidth={1.8} />
                  </motion.button>
                );
              })}
            </div>
